...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/gamelingua_logo.png
  AssetGenImage get gamelinguaLogo => const AssetGenImage('assets/images/gamelingua_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [gamelinguaLogo];
}
